...
%<TODO rework>
     ...
     Another popular method for dealing with inconsistency is to prioritize
     the constraints \citep{graf-1}. By assigning an inherent priority to each constraint,
     the system can intelligently decide which
     constraints to drop should a contradiction be encountered.
     A problem can
