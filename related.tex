   ...
   \subsection{Constraint satisfaction}
    ...
    \subsubsection{Types of constraints}
     ...
     \paragraph{Abstract constraints}
      ...
      “TEXT1 REFERENCES PIC1” and “TITLE IS IMPORTANT” are adequately
      ...
      While it may seem like “TEXT1 REFERENCES PIC1” implies that B and C
      should be relatively close to each other in the generated layout,
      abstract constraints by themselves do not specify the position and size
      of the components of a layout.
      ...
      abstract constraint “TEXT1 REFERENCES PIC1” into a combination of spatial
      constraints. The outcome of this operation could be that PIC1 is placed
      right next to text TEXT1, or that PIC1 is put on a different page with
      some visual cue to guide the audience to it from TEXT1.
